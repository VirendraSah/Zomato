    ...
    return (
        <>
            <section className='w-full h-[100vh] object-cover relative' id='Header'>
                <video className='w-[100%] h-[100%] object-cover relative' playsInline autoPlay loop muted>
                    <source src="/videos/Zomato.mp4" className='w-[100%]' type="video/mp4" />
                ...
                <div className='w-[100%] h-[100%] bg-gradient-to-b from-[#00000023] to-[#0f0f0fe1] absolute z-[9] top-0 flex  justify-end items-center flex-col text-white text-center gap-5 pb-20'>
                    <figure className='w-[150px] sm:w-[200px] mb-4'>
                        <img src="/images/8313a97515fcb0447d2d77c276532a511583262271.webp" alt="zomato" className='w-100%' />
                    </figure>
                    ...
                    <div className='w-full flex gap-5 items-center justify-center px-5'>
                        <figure className='h-[70px] hidden sm:block'>
                            <img src="images/aad864bd17860b27634fe621001c32db1739350431.webp" alt="google-play-btn" className='h-full' />
                        </figure>
                        <figure className='h-[70px] hidden sm:block'>
                            <img src="images/df6464de32f4a09262cee301f65aaa661739351256.webp" alt="apple-app-store" className='h-full' />
                        </figure>
