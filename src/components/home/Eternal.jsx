...
export function Eternal() {
    ...
    return (
        <>
            ...
            <section className='w-full pb-20 py-10'>
                <div className="flex flex-col gap-7">
                    <div>
                        ...
                        <div className="flex items-center justify-center gap-5 mt-10">
                            ...
                            <span className="text-center text-[rgb(118_124_143)] lexend font-semibold sm:text-xl md:text-2xl">POWERING INDIA’S <br /> CHANGING LIFESTYLES</span>
